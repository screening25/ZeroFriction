...
const VERSION_LOGS: VersionLog[] = [
  { version: "v0.8.2", date: "2026-06-08", latest: true, items: [
    { b: "고객사 목록을 리스트형으로 변경", t: ": 흩어진 태그(뱃지) 대신 깔끔한 세로 리스트로 표시합니다. 일정·재고·메모의 고객사 선택은 체크 표시가 있는 목록에서 고르고(입력으로 검색도 가능), 설정의 고객사 관리도 번호가 매겨진 목록으로 정리했습니다." },
  ] },
